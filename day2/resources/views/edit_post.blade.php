...
<form action="{{ route('posts.update')}}" method="post" enctype="multipart/form-data">
  ...
  <input name="title" type="text" class="form-control" id="exampleFormControlInput1" value = "{{$post['title']}}" placeholder="title ..">
</div>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input  name="name" type="text" class="form-control" id="exampleFormControlInput2" placeholder="name .." value = "{{$post['creator_name']}}">
</div>
  ...
  <input type="hidden" class="form-control-file" name='image2' value="{{ $post['image'] }}">
  <input type="hidden" class="form-control-file" name='id' value="{{ $post['id'] }}" >
